    ...
    <section className="w-full bg-white dark:bg-black transition-colors duration-300 py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 xl:px-20 2xl:px-32">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white transition-colors mb-4">
            How Hojo Works
          </h2>
          <p className="text-xl text-gray-600 dark:text-gray-300 transition-colors max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 transition-colors mb-2">
                {title}
              </h3>
