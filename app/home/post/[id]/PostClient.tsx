...
// Markdown components (keeping the same styling)
...
export default function PostClient({ id }: PostClientProps) {
      ...
      <div className="min-h-screen bg-white dark:bg-black flex items-center justify-center">
        <div className="flex flex-col items-center space-y-4">
          ...
          <div className="relative">
            <div className="w-16 h-16 bg-[#EF3866]/20 dark:bg-[#ff7a9c]/20 rounded-full animate-ping"></div>
            <div className="absolute inset-0 w-16 h-16 bg-[#EF3866]/40 dark:bg-[#ff7a9c]/40 rounded-full animate-pulse"></div>
            <div className="absolute inset-2 w-12 h-12 bg-[#EF3866] dark:bg-[#ff7a9c] rounded-full animate-bounce"></div>
          </div>
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black transition-colors duration-300">
      ...
      <header className="pt-4 pb-6 px-4 md:px-6 lg:px-8 max-w-5xl mx-auto">
        <div ref={heroRef}>
          ...
          {/* Title */}
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-light text-gray-900 dark:text-white mb-4 leading-tight tracking-tight">
            {post.title}
          </h1>
      ...
      <article className="px-4 md:px-6 lg:px-8 max-w-5xl mx-auto">
        <div ref={contentRef}>
          {/* Content */}
          ...
          <div className="sticky bottom-14 z-40 mb-12">
          ...
          {/* Comments Section */}
          <section id="comments" className="border-t border-gray-100 dark:border-gray-800 pt-8">
      ...
      {(post.prevPost || post.nextPost) && (
        <nav className="border-t border-gray-100 dark:border-gray-800 mt-12 pt-6 px-4 md:px-6 lg:px-8 max-w-5xl mx-auto">
