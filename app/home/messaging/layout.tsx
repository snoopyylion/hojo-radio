...
export default function MessagesLayout({
  ...
  const isMessagesRoot = pathname === '/home/messaging';
  const activeConversationId = !isMessagesRoot ? pathname?.split('/home/messaging/')[1] : undefined;
  const isConversationPage = Boolean(activeConversationId && activeConversationId !== 'new');
  ...
  return (
    <MessagingLayout 
      ...
      showConversationListOnly={isMessagesRoot}
      showConversationContent={isConversationPage}
      showSidebar={true}
    >
      {children}
    </MessagingLayout>
